        ...
        <div className="max-w-full mt-10 pb-20 mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0 py-6">
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-12">
              <Link href="/hiring" className="hover:text-gray-300 transition duration-300">
                Hiring
              </Link>
              <Link href="/case-studies" className="hover:text-gray-300 transition duration-300">
                Case studies
              </Link>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="bg-purple-500 rounded-full p-2 hover:bg-purple-600 transition duration-300">
                <svg 
