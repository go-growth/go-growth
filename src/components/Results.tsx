...
const MILESTONES: Milestone[] = [
  { label: "1 Week", title: "Within 1 Week — Clarity", bullets: [
  ...
  { label: "1 Month", title: "Within 1 Month — Momentum", bullets: [
  ...
  { label: "3 Months", title: "Within 3 Months — Growth", bullets: [
  ...
  { label: "6 Months", title: "Within 6 Months — Scalable", paragraph:
...
export function ResultsScroller() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-16">
      ...
      >
        {/* The space-y-8 creates the gap between cards */}
          ...
          {MILESTONES.map((m, i) => (
            <div
              ...
              className="
                ...
                mx-auto
                w-[92%] max-w-[440px]
                h-[52vh] flex-none             /* shorter than container to allow visible gap */
                rounded-lg
            ...
            >
              ...
              {m.bullets ? (
                <ul className="space-y-2 text-[13px] md:text-[14px] leading-6" style={{ color: MUTED }}>
                  {m.bullets.map((b) => (
                    <li key={b}>{b}</li>
                  ))}
                </ul>
