    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      {submitSuccess ? (
        ...
        >
          ...
          {/* How did you discover us - Required (NEW) */}
          <div className="mb-4 md:col-span-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              {["Organic Content", "Ads", "Referral"].map((option) => (
                <label
                  key={option}
                  className="flex items-center gap-2 rounded-md border border-white/50 bg-[#1a1a1a] px-4 py-3 cursor-pointer"
                >
                  <input
                    type="radio"
                    name="discovered_via" // EmailJS field name
                    value={option}
                    required
                    checked={formData.discoveredVia === option}
                    onChange={handleChange}
          ...
          <div className="mb-4 md:col-span-2">
            <label
              ...
              htmlFor="budget"
            >
              What&rsquo;s your approximate monthly marketing budget?{" "}
              <span className="text-red-400">*</span>
            </label>
            <select
              id="budget"
